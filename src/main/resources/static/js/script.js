    ...
    success: function (response) {
      ...
      if (response.status == "created") {
        let options = {
          ...
          description: "Donation",
          image:
            "https://scontent.fnag1-5.fna.fbcdn.net/v/t39.30808-6/371908688_2019099471796003_2276111562316110382_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=5f2048&_nc_ohc=rcTMHRj7_ZAQ7kNvgEmbzeU&_nc_ht=scontent.fnag1-5.fna&oh=00_AYA6f2W5tvheuvn_kSHa8aNrgTpZxWOzSaDNW1-yUOeqZQ&oe=6659CE9F",
          order_id: response.id,
          handler: function (response) {
